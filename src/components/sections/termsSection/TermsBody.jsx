      ...
      <div className="space-y-5 mb-4 md:mb-16">
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-sm md:text-[15px] text-CharcoalGrey">
              ...
              ************************* DESCRIBE SERVICES IN DETAIL (“Services”)
              ...
              communications of or between, Users identified through the
              SmartComply Platform, whether in public or private, via on- or
              off-line interactions, or otherwise howsoever.
            </p>
          </div>
          <div className="space-y-2">
            <h4 className="font-test-sohne-medium text-base md:text-lg text-opacity-60">
            ...
            <p className="uppercase">
              NEITHER SMARTCOMPLY, NOR ITS PARENTS, AFFILIATES OR LICENSORS,
              INCLUDING THEIR RESPECTIVE DIRECTORS, OFFICERS, SHAREHOLDERS,
              AGENTS, INVESTORS, SUBSIDIARIES, ATTORNEYS, REPRESENTATIVES,
              INSURERS, EMPLOYEES, SUCCESSORS AND ASSIGNS (COLLECTIVELY REFERRED
              TO AS “AFFILIATES” ) IS RESPONSIBLE OR LIABLE FOR THE CONDUCT,
              ACTS, OR OMISSIONS, WHETHER ONLINE OR OFFLINE, OF ANY USER OF THE
              SMARTCOMPLY PLATFORM AND, TO THE EXTENT PERMITTED BY LAW, YOU
              HEREBY RELEASE SMARTCOMPLY AND AFFILIATES FROM ANY AND ALL
              LIABILITY, CLAIMS, DEMANDS, OR DAMAGES OF EVERY KIND AND NATURE,
              KNOWN AND UNKNOWN, SUSPECTED AND UNSUSPECTED, DISCLOSED AND
              UNDISCLOSED, ARISING OUT OF OR IN ANY WAY CONNECTED WITH THE
              SMARTCOMPLY PLATFORM.
            </p>
            <p className="text-sm md:text-[15px] text-CharcoalGrey">
            ...
            <ul className="list-disc text-sm md:text-[15px] text-CharcoalGrey px-4">
              <li>
                ...
                in which you reside (18 years of age or older), and are
              ...
              <li>
                ...
                Agreement, and that you will so abide;
              </li>
              <li>
                You have read, understand, and agree to be bound by these Terms
                of Service and the Privacy Policy applicable to the country
                where the Service is performed;
              </li>
              <li>
                When using or accessing the SmartComply Platform, you will act
                in accordance with all applicable local, state, provincial,
                national, or international law or custom and in good faith;
              </li>
              <li>
                Where you enter into this Agreement on behalf of a company or
                other organization, you represent and warrant that you have
            ...
            <ul className="list-disc text-sm md:text-[15px] text-CharcoalGrey px-4">
              <li>
                When using the SmartComply Platform, you are operating as a
                partnership, limited liability company, limited liability
                partnership, corporation or other business entity;
              </li>
              <li>
                You have the unrestricted right to work in the jurisdiction in
                which you will be performing Services;
              </li>
              <li>
                If the Service is performed in a jurisdiction that requires you
                to have a business license or business tax registration, you
                have the required business license or business tax registration;
              </li>
              <li>
                You are responsible for identifying and obtaining any required
                licenses, permits, or registrations before offering services and
                undertaking Services (including but not limited to professional
                qualifications required by Lawyers and Accountants to practice
                in their respective fields);
              </li>
              <li>
                You have any and all insurance required to operate your business
                and provide your services; You will only offer and provide
                services for which you have the necessary skills and expertise,
                and provide those services safely and in accordance with all
                applicable laws.
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-2">
            ...
            <ul className="list-disc text-sm md:text-[15px] text-CharcoalGrey px-4">
              ...
              <li>
                To advertise or offer to sell any goods or services for any
                commercial purpose through the SmartComply Platform which are
                not relevant to the Service; While using the SmartComply
                Platform, you may not:
              </li>
              <li>
                Use the SmartComply Platform for any unauthorized or illegal
                purpose, including but not limited to posting or performing a
                Service in violation of local, state, provincial, national, or
                international law;
              </li>
              <li>
                Use a robot, spider, manual, meta tag, “hidden text,” agent,
                robot, script, and/or automatic processes or devices to
                data-mine, data-crawl, scrape, collect, mine, republish,
                redistribute, transmit, sell, license, download, manage or index
                the SmartComply Platform, or the electronic addresses or
                personal information of others, in any manner;
              </li>
              <li>
                Frame or utilize framing techniques to enclose the SmartComply
                Platform or any portion thereof;
              </li>
              <li>
                Hack or interfere with the SmartComply Platform, its servers or
                any connected networks;
              </li>
              <li>
                Adapt, alter, license, sublicense or translate the SmartComply
                Platform for your own personal or commercial use;
              </li>
              <li>
                Remove, alter, or misuse, visually or otherwise, any copyrights,
                trademarks or proprietary marks or rights owned by SmartComply
                and Affiliates;
              </li>
              <li>
                Solicit for any other business, website or service, or otherwise
                contact Users for employment, contracting or any purpose not
                related to use of the SmartComply Platform as set forth herein;
              </li>
              <li>
                Collect usernames, email addresses, or other personal
                information of Users by electronic or other means;
              </li>
              <li>
                Use the SmartComply Platform or the Service services in
                violation of this Agreement;
              </li>
              <li>
                Use the SmartComply Platform in a manner that is false or
                misleading (directly or by omission or failure to update
                information), or for the purpose of accessing or otherwise
                obtaining SmartComply’s trade secret information for public
                disclosure or other purposes;
              </li>
              <li>
                Attempt to circumvent the payments system or support fee in any
                way including, but not limited to, making or processing payments
                outside of the SmartComply Platform, providing inaccurate
                information on invoices, or otherwise invoicing in a fraudulent
                manner;
              </li>
              <li>
                Register under different usernames or identities after your
                account has been suspended or terminated, or register under
                multiple usernames or false identities, or register using a
                false or disposable email or phone number;
              </li>
              <li>
              ...
              <li>
                Use tools with the goal of masking your IP address (like the TOR
                network).
              </li>
              <li>
                You understand that all submissions made to Public Areas will be
                public and that you will be publicly identified by your name or
                login identification when communicating in Public Areas.
                SmartComply will not be responsible for the action of any Users
                with respect to any information or materials posted in Public
                Areas.
              </li>
            </ul>
          </div>
          <div className="space-y-2">
            ...
            <p className="text-sm md:text-[15px] text-CharcoalGrey">
              By installing the App(s), you consent to the installation of the
              App(s) and any updates or upgrades that are released through the
              SmartComply Platform. The App (including any updates or upgrades)
              may (i) cause your device to automatically communicate with
              SmartComply’s servers to deliver the App functionality and to
              record usage metrics, (ii) affect App-related preferences or data
              stored on your device, and (iii) collect personal information as
              set out in our Privacy Policy. You can uninstall the App(s) at any
              time.
            </p>
          </div>
          <div className="space-y-2">
            ...
            <p className="text-sm md:text-[15px] text-CharcoalGrey">
              SmartComply may suspend your right to use the SmartComply Platform
              pending its investigation of a potential breach by you of this
              Agreement. SmartComply may deactivate your account or limit your
              use of the SmartComply Platform upon its determination that you
              breached a provision of this Agreement (a “User Breach”).
              SmartComply will provide you with written notice of its
              determination as required by law, unless we have reason to believe
              the User’s account has been compromised such that the notice would
              go to the wrong person, or notice would otherwise be
              counterproductive or would create a risk to safety. If you wish to
              appeal this determination, please contact info@SmartComplyapp.com
              within 14 days of receipt of such notice with the grounds for your
              appeal.
            </p>
            <p className="text-sm md:text-[15px] text-CharcoalGrey">
              If SmartComply suspends or deactivates your account or limits your
              use of the SmartComply Platform, you are thereafter prohibited
              from registering and creating a new account under your name or
              business name, a fake or borrowed name, or the name of any third
              party, even if you may be acting on behalf of the third party.
            </p>
            <p className="text-sm md:text-[15px] text-CharcoalGrey">
              Even after your right to use the SmartComply Platform is
              suspended, terminated or limited, this Agreement will remain
              enforceable against you. SmartComply reserves the right to take
              appropriate legal action pursuant to the Agreement.
            </p>
            <p className="text-sm md:text-[15px] text-CharcoalGrey">
              SmartComply reserves the right to modify or discontinue,
              temporarily or permanently, all or any portion of the SmartComply
              Platform at its sole discretion. SmartComply will provide you with
              notice of any such modification or discontinuation as required by
              law. To the extent permitted by law, SmartComply shall not be
              liable to you for any modification or discontinuance of all or any
              portion of the SmartComply Platform. SmartComply has the right to
              restrict anyone from completing registration if such person may
              threaten the safety and integrity of the SmartComply Platform, or
              if such restriction is necessary to address any other reasonable
              business concern.
            </p>
            <p className="text-sm md:text-[15px] text-CharcoalGrey">
              You may terminate this Agreement at any time by ceasing all use of
              the SmartComply Platform and deactivating your account.
            </p>
            <h4 className="font-test-sohne-medium text-base md:text-lg text-opacity-60">
              8. ACCOUNT, PASSWORD, SECURITY, AND TELEPHONE COMMUNICATIONS
            </h4>
            <p className="text-sm md:text-[15px] text-CharcoalGrey">
              You must register with SmartComply and create an account to use
              the SmartComply Platform. You are responsible for maintaining the
              confidentiality of any log-in, password, and account number
              provided by you or given to you by SmartComply for accessing the
              SmartComply Platform. You are solely and fully responsible for all
              activities that occur under your password or account, even if not
              authorized by you. SmartComply has no control over the use of any
              ...
              using your password or account or you suspect any other breach of
              security, you agree to notify SmartComply immediately.
            </p>
            <p className="text-sm md:text-[15px] text-CharcoalGrey">
              You acknowledge that telephone calls to or from SmartComply,
              together with its agents and Affiliates, may be monitored and
              recorded for the purposes of quality control and training.
            </p>
            <p className="text-sm md:text-[15px] text-CharcoalGrey">
              You verify that any contact information provided to SmartComply,
              its agents and Affiliates, and Users, including, but not limited
              to, your name, business name, mailing address, email address, your
              residential or business telephone number, and/or your mobile
              telephone number, is true and accurate. You verify that you are
              the current subscriber or owner of any telephone number that you
              ...
              in connection with your registration is false or inaccurate, we
              may suspend or deactivate your account. Should any of your contact
              information change, you agree to immediately notify SmartComply
              before the change goes into effect by visiting ……………………….. If the
              change regards ownership of your telephone numbers, you may notify
              SmartComply through their customer support email/number which can
