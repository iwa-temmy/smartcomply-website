...
const PricingModal = ({ closeModal, isOpen, paymentMethods, activePlan, standardPrices }) => {
    ...
    const handleSubmit = async e => {
        ...
        if (!acknowledgement) {
            setErrorMsg({
                ...errorMsg,
                acknowledgement: "Oops! We can't proceed without your consent, please, tick the box",
            });
            return;
        }
    ...
    return (
        <Modal
            ...
            height="h-[75vh]"
        >
            <form className="flex flex-col lg:flex-row w-full h-full relative" onSubmit={handleSubmit}>
                    ...
                    <div className="flex flex-col mt-[8rem] px-[3rem] h-full w-full items-center">
                        <div className="w-full my-4">
                            <Input
                                ...
                                onChange={e => /^[0-9]*$/g.test(e.target.value) && setEmployee(e.target.value)}
                                value={employees}
                                type="number"
                                name="employee"
                                id="employee"
                        ...
                        <div className="w-full my-4">
                            <label className="py-4">Choose your auditing compliance standard:</label>
                                    ...
                                    standardPrices?.map((item, index) => {
                                        return (
                                            <CheckboxInput
                                                ...
                                                styles=""
                                                onChange={e =>
                                                    handleStandardChange(item?.standard_type, e.target.checked)
                                                }
                                            />
                                        );
                                    })
                            ...
                            {errorMsg?.standards?.length && (
                                <p className="text-[#F85359] text-[12px] pt-1">{errorMsg?.standards}</p>
                            )}
                        </div>
                        <div className="w-full my-4">
                ...
                <div className="w-full lg:w-[45%] bg-[#EEF0FF] h-full">
                    <div className="flex flex-col mt-[8rem] px-[3rem] h-full w-full ">
                        ...
                        >
                            <span className='font-bold'>Standard Payment:</span> 70% payment before commencement and 30% payment after completion.
                        </div>
                        ...
                        <div className="w-full">
                            ...
                            <div className="flex w-full items-center my-4 sample_dropdown">
                                ...
                                />
                                <label htmlFor="consent" className="textbrandColor text-[12px] font-[400] ml-3">
                            ...
                            >
                                By clicking <span className='font-bold'>Get Started</span>, you agree to Smartcomply’s privacy and terms
                            </div>
                            <Button
                                text="submit"
                                variant="primary"
