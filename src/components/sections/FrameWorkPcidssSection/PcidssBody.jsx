            ...
            <div className="w-full md:w-1/2">
              ...
              <div className="space-y-4 md:space-y-8 relative -top-10">
                ...
                <p className="text-Boulder text-sm md:text-[15px] font-test-sohne-light">
                  Smartcomply has an automated feature that allows businesses to
                  generate baseline policies and documentation for identifying
                  security controls across multiple systems. Smartcomply
                  automatically gathers audit evidence for your assessment.
                </p>
              </div>
            </div>
            <div className="w-full md:w-1/2 ">
              ...
              <div className="space-y-4 md:space-y-8 relative -top-10">
                <h3 className="text-2xl md:text-4xl font-test-sohne-medium flex flex-col">
                  <span>Cybersecurity Metrics </span>{" "}
                  <span>and Measurement</span>
                </h3>
                <p className="text-Boulder text-sm md:text-[15px] font-test-sohne-light">
                  Smartcomply monitors your cybersecurity posture continuously
                  by integrating with businesses’ technologies and processes to
                  provide valuable insight into your current cybersecurity
                  posture. Metrics for your cybersecurity status for control
                  objectives are automated, eliminating dark holes and
                  identifying out-of-sight cyber threats.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto flex flex-col space-y-4 items-center lg:flex-row md:justify-start md:items-center py-8">
          <div className="w-full md:w-1/2 space-y-4">
            ...
            <p className="text-sm md:text-base font-test-sohne-light max-w-md">
              Smartcomply empowers businesses' cybersecurity strategy with
              Automated Risk Assessment solution by streamlining the processes,
              and helping businesses gain real-time insights, yet fortifying
              their defences effortlessly.
            </p>
          </div>
