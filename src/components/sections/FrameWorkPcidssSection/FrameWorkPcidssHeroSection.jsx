      ...
      <div className="py-5 md:py-10 mb-2">
        <div className="container mx-auto flex flex-col space-y-8 md:space-y-0 md:flex-row">
          <div className="w-full md:w-1/2 space-y-4 md:space-y-6">
            ...
            The Payment Card Industry Data Security Standard (PCI DSS) is a collection of security principles that must be followed by any company that deals with credit card information in any capacity, including accepting, processing, storing, or transmitting it.
            </p>
          </div>
